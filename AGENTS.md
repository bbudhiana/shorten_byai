...
- **Environment:** Linux / VPS (Ubuntu 26.04, frankenphp, PHP 8.x, MariaDB).
...
- Aplikasi berjalan di docker container 'frankenphp' yaitu http://localhost:8002 dan sudah dipasang mengarah ke root aplikasi folder public
- Database menggunakan mariadb dengan docker container dan memiliki root password 'Bunciono12345!', host 'mariadb'
